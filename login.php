        ...
        <div class="main-div">
                ...
                <div class="row">
                    <div class="col-lg-4 offset-lg-4 text-center">
                        <div class="section-heading">
                            <img src="assets/css/l.png" style="width: 80%;">
                        </div>
                    </div>
                </div>
            </div>
            <form method="post" action="">
                ...
                <div class="container" style="width: 30%; margin: auto;">
                    ...
                    <button type="submit" class="btn btn-primary" style="background-color: #AC7088; width: 80%; margin-left: 10%; margin-top:5%; border: 1px #80da62;" name="submit">Uloguj se</button>
                    <br><br>
                </div>
            </form>
        </div>
